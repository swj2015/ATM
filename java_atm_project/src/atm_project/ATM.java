...
public class ATM extends JFrame {
	...
	private static int num2;	// user 식별
    ...
    public static void main(String[] args) {
    	...
    	JLabel ad35 = new JLabel("트랜젝션 로그 조회 : "+ Log);
    	
    	
    	
    	ad35.setBounds(50, 50, 300, 30);
        ...
        //JLabel user35 = new JLabel("계좌 조회 결과를 표시합니다.");
